...
class DepreciationCalculation extends BaseController
{
    ...
    public function Date()
    {
        ...
        foreach ($assets as $asset) {
            ...
            $cfs_last_yr_depreciation = (float) preg_replace('/,/', '', $asset->cfs_last_yr_depreciation);


            // echo $fixed_amount.' = '.$cfs_last_yr_depreciation;exit;
    ...
    public function View()
{
    ...
    public function AddToJvRows()
    {
        ...
        <tr class="jv_row">
                                  ...
                                  <th class="p-0"><input name="jv_debit[]" type="number" step="0.01" class="form-control debit_amount text-end" value="' . $dep_amount  . '" readonly></th>
