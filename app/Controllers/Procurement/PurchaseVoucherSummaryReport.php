...
class PurchaseVoucherSummaryReport extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('procurement/purchase_voucher_summary_report', $data);
    ...
    public function Pdf($purchase_order, $from_date, $to_date)
    {
        if (!empty($purchase_order)) {
            ...
            foreach ($purchase_order as $order_data) {
                ...
                // Fetch Vendor Name
                $vendor = $this->common_model->SingleRow('crm_customer_creation', ['cc_id' => $order_data->pv_vendor_name]);
                ...
                // 1. Date
                $pdf_data .= "<td style='border-top: 2px solid'>{$new_date}</td>";

                // 2. Vendor Invoice Ref (Using variable from original PDF logic)
            ...
            $mpdf->SetTitle('Purchase Voucher Report');
            ...
            <table width="100%" style="margin-top:10px;">
                <tr width="100%">
                    <td>Period : ' . $dates . '</td>
                    <td align="right"><h2>Purchase Voucher Report</h2></td>
                </tr>
            </table>
            ...
            <table width="100%" style="margin-top:2px;border-collapse: collapse; border-spacing: 0;border-top:2px solid;">
                ...
                <thead>
                    <tr>
                        ...
                        <th align="left">Vendor Inv Ref</th> <!-- Updated Header -->
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="border-top: 2px solid;"></td>
                        <td style="border-top: 2px solid;"></td>
                        <td style="border-top: 2px solid; text-align:right; font-weight:bold;">' . format_currency($total_amount) . '</td>
                    </tr>    
                </tfoot>
