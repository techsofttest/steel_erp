...
class PurchaseReturn extends BaseController
{
    ...
    {   
        ...
        if(empty($this->request->getPost('purchase_return_id')))
        {   
           

            $insert_data = [

                'pr_reffer_id'       => $this->request->getPost('purchase_reffer_no'),

                'pr_date'            => date('Y-m-d',strtotime($this->request->getPost('purchase_date'))),

                'pr_vendor_name'     => $this->request->getPost('purchase_vendor_name'),

                'pr_vendor_inv'      => $this->request->getPost('purchase_vendor_inv'),

                'pr_lpo'             => $this->request->getPost('purchase_lpo_ref'),

                'pr_contact_person'  => $this->request->getPost('purchase_contact'),

                'pr_payment_term'    => $this->request->getPost('purchase_payment_term'),
        ...
        foreach ($idsArray as $number) 
        {
            ...
            foreach($products as $product){
                ...
                $data['product_detail'] .='<tr class="add_prod_row add_prod_remove" id="'.$product->pop_id.'">
                                            <td class="si_no">'.$i.'</td>
                                            <td><input type="text" name="pvp_sales_order[]" value="'.$product->so_reffer_no.'" class="form-control" readonly></td>
                                            <td><input type="text" name="pvp_product_desc[]" value="'.$product->product_details.'" class="form-control" readonly></td>
                                            <td>
                        ...
                        $data['product_detail'] .='</select>
                                            ...
                                            <td><input type="number" name="pvp_qty[]" value="'.$product->pop_qty.'"  class="form-control add_prod_qty" readonly required></td>
                                            <td><input type="text" name="pvp_unit[]" value="'.$product->pop_unit.'" class="form-control" required readonly></td>
                                            <td><input type="text" name="pvp_rate[]" value="'.$product->pop_rate.'"  class="form-control add_prod_rate" required readonly></td>
                                            <td><input type="text" name="pvp_discount[]" value="'.$product->pop_discount.'"  class="form-control add_discount" required readonly></td>
                                            <td><input type="text" name="pvp_amount[]" value="'.$product->pop_amount.'"  class="form-control add_prod_amount" required readonly></td>
    ...
    {   
        ...
        $purchase_voucher = $this->common_model->FetchWhere('pro_purchase_voucher',array('pv_vendor_name' => $this->request->getPost('ID')),);
