...
class MaterialReceivedNote extends BaseController
{
    ...
    public function FetchData()
    {
        ...
        foreach($records as $record ){
            $action = '<a  href="javascript:void(0)" data-id="'.$record->mrn_id.'"  class="view view-color view_btn" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="ri-eye-fill"></i></a>
            <a  href="javascript:void(0)" class="edit edit-color edit_btn" data-toggle="tooltip" data-placement="top" title="Edit"  data-id="'.$record->mrn_id.'" data-original-title="Edit"><i class="ri-pencil-fill"></i></a>
            <a href="javascript:void(0)" class="delete delete-color delete_btn" data-toggle="tooltip" data-id="'.$record->mrn_id.'"  data-placement="top"  title="Delete"><i  class="ri-delete-bin-fill"></i></a>
            ';
           ...
           $data[] = array( 
              ...
              'mrn_total_amount'   => format_currency($record->mrn_total_amount),
              "action"             => $action,
           );
           $i++; 
        }
        ...
        foreach ($idsArray as $number) 
        {
            ...
            foreach($products as $product){
                ...
                $data['product_detail'] .='<tr class="add_prod_row add_prod_remove" id="'.$product->pop_id.'">
                                            ...
                                            <input type="hidden" name="prod_desc[]" value="'.$product->product_details.'">
