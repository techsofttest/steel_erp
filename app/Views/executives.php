        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">View Executives</h4>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Executives</h5>
                ...
                <div class="card-body">
                    ...
                    <!-- Single Row Start -->
                            ...
                            <div class="col-col-md-3 col-lg-3">
                                ...
                                <input type="text" name="se_name" class="form-control" required>
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                            ...
                                            <div class="col-col-md-3 col-lg-3">
                                                    ...
                                                    <div class="col-col-md-9 col-lg-9">
                                                        <input type="text" id="edit_name" value="" name="se_name" class="form-control " required>
                                                    </div>
                                                </div>
                                                ...
                                                <!--end col-->
                                                <input type="hidden" name="se_id" id="id" value="">
    ...
    document.addEventListener("DOMContentLoaded", function(event) { 
        ...
        $(function() {
            $('#add_form').validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>Executives/Add",
                        method: "POST",
                        data: $(form).serialize(),
        ...
        $("body").on('click', '.edit_btn', function(){ 
            ...
            $.ajax({
                ...
                url : "<?php echo base_url(); ?>Executives/Edit",
        ...
        $(function() {
            $('#update_form').validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>Executives/Update",
                        method: "POST",
                        data: $(form).serialize(),
                        success: function(data) {
        ...
        $("body").on('click', '.delete_btn', function(){ 
            ...
            $.ajax({
                ...
                url : "<?php echo base_url(); ?>Executives/Delete",
        ...
        function initializeDataTable() {
         datatable =  $('#DataTable').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': "<?php echo base_url(); ?>Executives/FetchData",
                    'data': function (data) {
                        // CSRF Hash
