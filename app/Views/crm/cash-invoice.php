                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="ci_date" autocomplete="off" class="form-control datepicker_ap input_length" required>
                                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row align-items-center mb-2">
                                            ...
                                            <div class="col-col-md-9 col-lg-9">
                                                <input type="text" name="ci_date" autocomplete="off" class="form-control datepicker_ap edit_date" required>
                                            </div>
                                        </div> 
                                    </div>    
