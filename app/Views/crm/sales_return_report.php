                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="SalesReturnReport" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <form  class="Dashboard-form class" id="sales_return_form">
                                                                    ...
                                                                    <table class="table table-bordered table-striped delTable">
                                                                        <thead class="travelerinfo contact_tbody">
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="date" name="form_date" id=""  class="form-control" required ></td>
                                                                                <td>To</td>
                                                                                <td><input type="date" name="to_date" id=""  class="form-control" required ></td>
