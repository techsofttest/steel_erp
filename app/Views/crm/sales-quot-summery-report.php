                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="SalesQuotReport" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                ...
                                <form method="GET" action="<?php echo base_url(); ?>Crm/SalesQuotSummerReport/GetData" target="_blank" class="Dashboard-form class" id="add_form">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Sales Quotation Summery Report</h5>
                            ...
                            <div class="col-lg-12" style="padding:0px">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1" style="text-align: center;font-weight: 600;color: black; margin-right:-18%"> Sales Quotation Summery Report  <?php if (!empty($from_dates) && !empty($to_dates)) { ?>(<?php echo $from_dates; ?> To <?php echo $to_dates; ?>)<?php } ?></h4>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        $('body').on('click','.print_button',function(e){
            ...
            var pdfWindow = window.open('<?= base_url()."Crm/SalesQuotSummerReport/GetData/?".$_SERVER['QUERY_STRING']?>&action=Print', '_blank');
        ...
        $("body").on('change', '.customer_clz', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>Crm/SalesQuotSummerReport/FetchData",
    ...
    function fnExcelReport(table, fileName) {
        ...
        $(".droup_customer").select2({
            ...
            ajax: {
                url: "<?= base_url(); ?>Crm/SalesQuotSummerReport/FetchCustomer",
                dataType: 'json',
                delay: 250,
                cache: false,
