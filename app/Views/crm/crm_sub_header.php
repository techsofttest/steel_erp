    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs nav-border-top nav-border-top-primary mb-3" role="tablist">
          <li class="nav-item"><a class="nav-link <?php if($uri->getSegment(3)=="AccountHead") {echo "active" ;} ?>"  href="<?= base_url(); ?>Crm/ProductHead" role="tab" aria-selected="true">Product Details </a></li>
