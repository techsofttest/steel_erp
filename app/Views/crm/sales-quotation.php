                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="qd_project" id="" class="form-control enqinput project_clz input_length2">
                                                                    </div>
                                                    ...
                                                    <table class="table table-bordered table-striped delTable add_table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="cost_cal_row cost_cal_row2">
                                                                ...
                                                                <td><input type="text" name="qc_qty[0]" class="form-control cost_qty_clz text-center" required></td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="qd_project" id="" class="form-control edit_project input_length">
                                                                    </div>
                                                    ...
                                                    <table class="table table-bordered table-striped delTable ">
                                                        ...
                                                        <tbody>
                                                            <tr class="edit_cost_cal_row">
                                                                ...
                                                                <td><input type="text" name="qc_qty" class="form-control edit_cost_qty text-center" required></td>
                                                                <td style="text-align: center;padding: 10px 10px;background: #f5f5f56e;"><a href="javascript:void(0)" onclick="editcostVendor.call(this)">Click</a></td>
                                                                <td><input type="text" name="qc_rate"  class="form-control edit_cost_rate text-end" required></td>
                                                                
                                                                <td><input type="text" name="qc_amount" class="form-control edit_cost_amount text-end" readonly></td>
                                                    ...
                                                    <table class="table table-bordered table-striped delTable add_table">
                                                        ...
                                                        <tbody>
                                                            <tr class="edit_add_cost_cal_row">
                                                                ...
                                                                <td><input type="text" name="qc_unit"  class="form-control text-center" required></td>
                                                                <td><input type="text" name="qc_qty" class="form-control edit_add_qty text-center" required></td>
                                                                <td style="padding-top: 10px;" class="text-center"><a href="javascript:void(0)" onclick="editAddCostVendor.call(this)" class="text-center">Click</a></td>
                                                                <td><input type="text" name="qc_rate"  class="form-control edit_add_rate text-end" required></td>
                                                                
                                                                <td><input type="text" name="qc_amount" class="form-control edit_add_amount text-end" readonly></td>
                                                    ...
                                                    <table class="table table-bordered table-striped delTable add_table">
                                                        ...
                                                        <tbody>
                                                            <tr class="edit_add_prod_det_row">
                                                                ...
                                                                <td><input type="text" name="qpd_quantity" class="form-control edit_add_prod_qty text-center" required></td>
...
/*#####*/
       ...
       // var pp = 1;
        ...
        function reName(){
            ...
            $('body .quot_row_leng').each(function() {
                ...
                $(this).closest('.quot_row_leng').find('.add_select2_prod').attr('name', 'qpd_product_description['+jj+']');
        ...
        function slno(){
            ...
            $('body .prod_row').each(function() {
                ...
                $(this).find('.si_no').html('<td class="si_no" style="border: unset;display: flex;align-items: center;justify-content: center;">' + pp + '</td>');
        ...
        function EditCostProdDet(){
            $(".edit_cost_product_det:last").select2({
                placeholder: "Select Product",
                theme : "default form-control- droup_color select_width",
                //dropdownParent: $('#CostCalculation'),
                dropdownParent: $($('.edit_cost_product_det:last').closest('.edit_cost_cal_row')),
                ajax: {
                    url: "<?= base_url(); ?>Crm/SalesQuotation/FetchCostMetal",
                    dataType: 'json',
                    delay: 250,
        ...
        $("body").on("input", ".cost_rate_clz", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/[^0-9.]/g, ""); // Allow only numbers and one decimal point
        ...
        $("body").on("blur", ".cost_rate_clz", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/,/g, ""); // Remove existing commas
        ...
        $("body").on("input", ".cost_qty_clz", function () {
        ...
        $("body").on("input change", ".cost_qty_clz, .cost_rate_clz", function () {
            ...
            var rateElement = $this.closest(".cost_cal_row").find(".cost_rate_clz");
            var quantityElement = $this.closest(".cost_cal_row").find(".cost_qty_clz");
            ...
            // Format calculated price with commas
            var formattedPrice = multipliedTotal.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 });

            var amountElement = $this.closest(".cost_cal_row").find(".cost_amount_clz");
            amountElement.val(formattedPrice);
       ...
       $("body").on('click', '.cust_more_modal', function(){ 
        ...
        $("body").on("input", ".edit_cost_rate", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/[^0-9.]/g, ""); // Allow only numbers and one decimal point
        ...
        $("body").on("blur", ".edit_cost_rate", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/,/g, ""); // Remove existing commas
        ...
        $("body").on("input", ".edit_cost_qty", function () {
        ...
        $("body").on("input change", ".edit_cost_qty, .edit_cost_rate", function () {
            ...
            var rateElement = $this.closest(".edit_cost_cal_row").find(".edit_cost_rate");
            var quantityElement = $this.closest(".edit_cost_cal_row").find(".edit_cost_qty");
            ...
            var amountElement = $this.closest(".edit_cost_cal_row").find(".edit_cost_amount");
            amountElement.val(formattedPrice);
        ...
        $("body").on("input change", ".edit_add_qty, .edit_add_rate", function () {
            ...
            var rateElement = $this.closest(".edit_add_cost_cal_row").find(".edit_add_rate");
            var quantityElement = $this.closest(".edit_add_cost_cal_row").find(".edit_add_qty");
            ...
            var amountElement = $this.closest(".edit_add_cost_cal_row").find(".edit_add_amount");
            amountElement.val(formattedPrice);
        ...
        /*$("body").on('keyup', '.edit_prod_dis , .edit_prod_qty , .edit_prod_rate', function(){ 
            ...
            var discount = parseFloat($discountSelect.closest('.edit_prod_row').find('.edit_prod_dis').val())||0;
        ...
        $("body").on("input", ".edit_add_prod_rate", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/[^0-9.]/g, ""); // Allow only numbers and one decimal point
        ...
        $("body").on("blur", ".edit_add_prod_rate", function () {
            var $this = $(this);
            var rawValue = $this.val().replace(/,/g, ""); // Remove existing commas
        ...
        $("body").on("input", ".edit_add_prod_qty", function () {
        ...
        $("body").on("input change", ".edit_add_prod_dis, .edit_add_prod_qty, .edit_add_prod_rate", function () {
            ...
            var rateElement = $this.closest(".edit_add_prod_det_row").find(".edit_add_prod_rate");
            var quantityElement = $this.closest(".edit_add_prod_det_row").find(".edit_add_prod_qty");
        ...
        /*$("body").on('keyup', '.edit_add_prod_dis , .edit_add_prod_qty , .edit_add_prod_rate', function(){ 
            ...
            var discount = parseFloat($discountSelect.closest('.edit_add_prod_det_row').find('.edit_add_prod_dis').val())||0;
        ...
        function ProductSelect2Edit() {
                $('body .add_select2_prod').each(function() {
                $(this).select2({
                    placeholder: "Select Product",
                    theme: "default form-control- select_width ",
    ...
    $('.datepicker_ap').change(function(){
        ...
        url: "<?php echo base_url(); ?>Crm/SalesQuotation/FetchReference/r/"+date+"",
