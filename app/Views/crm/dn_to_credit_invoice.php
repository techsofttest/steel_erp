                                                                    ...
                                                                    <table class="table table-bordered table-striped delTable">
                                                                        <thead class="travelerinfo contact_tbody">
                                                                            <tr>
                                                                                ...
                                                                                <td style="padding: 0px !important;"><input type="date" name="form_date" id="" value="<?php echo $from_date; ?>" onclick="this.showPicker();" class="form-control"></td>
                                                                                <td style="width: 10% !important;text-align: center;">To</td>
                                                                                <td style="padding: 0px !important;"><input type="date" name="to_date" id="" value="<?php echo $to_date; ?>" onclick="this.showPicker();" class="form-control"></td>
