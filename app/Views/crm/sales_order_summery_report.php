                                                                    ...
                                                                    <table class="table table-bordered table-striped delTable">
                                                                        <thead class="travelerinfo contact_tbody">
                                                                            <tr>
                                                                                ...
                                                                                <td ><input type="date"  name="form_date" value='<?php echo $from_date; ?>' id="from_date_id" onclick="this.showPicker();" class="form-control adjust_width"></td>
                                                                        ...
                                                                        <tbody class="travelerinfo">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 70%;" colspan="4" class="customer_sales_order_ref"><select class="form-select  sales_order" value='<?php echo $sales_order; ?>' name="sales_order">
                                                                            ...
                                                                            <tr>
                                                                                <td  class="center_padding" style="width: 30%; white-space: nowrap; vertical-align: middle;">Sales Executive</td>
...
<script>
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        $('body').on('click','.print_button',function(e){
              ...
              var pdfWindow = window.open('<?= base_url()."Crm/SalesOrderSummeryReport/GetData/?".$_SERVER['QUERY_STRING']?>&action=Print', '_blank');
        ...
        $(".droup_customer").select2({
            ...
            ajax: {
                url: "<?= base_url(); ?>Crm/SalesOrderSummeryReport/FetchCustomer",
                dataType: 'json',
                delay: 250,
                cache: false,
        ...
        $(".product_clz").select2({
            ...
            dropdownParent: $('#SalesOrderReport'),
            ajax: {
                url: "<?= base_url(); ?>Crm/SalesOrderSummeryReport/FetchProducts",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        /*###*/
         ...
         $(".sales_order").select2({
            ...
            dropdownParent: $('#SalesOrderReport'),
            ajax: {
                url: "<?= base_url(); ?>Crm/SalesOrderSummeryReport/FetchSalesOrder",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
