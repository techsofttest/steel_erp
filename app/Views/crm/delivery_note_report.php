                                                                    ...
                                                                    <table class="table table-bordered table-striped delTable">
                                                                        <thead class="travelerinfo contact_tbody">
                                                                            <tr>
                                                                                ...
                                                                                <td ><input type="date" style="margin-left: 10px;" name="form_date" id="from_date_id" value="<?php echo $from_date; ?>" onclick="this.showPicker();" class="form-control adjust_width"></td>
                                                                        ...
                                                                        <tbody class="travelerinfo">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 70%;" colspan="4"><select class="form-select product_clz" name="product" value="<?php echo $product; ?>">
                                                ...
                                                if (!empty($delivery_note)) {
                                                    ...
                                                    foreach ($delivery_note as $del_note) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="width: 300px; word-wrap: break-word; white-space: normal;"><?php echo $del_note->cc_customer_name; ?></td>
...
<script>
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        /*modal open end*/
         ...
         $('body').on('click','.print_button',function(e){
              ...
              var pdfWindow = window.open('<?= base_url()."Crm/DeliveryNoteReport/GetData/?".$_SERVER['QUERY_STRING']?>&action=Print', '_blank');
    ...
    $(".droup_customer").select2({
            ...
            ajax: {
                url: "<?= base_url(); ?>Crm/DeliveryNoteReport/FetchCustomer",
                dataType: 'json',
                delay: 250,
                cache: false,
        ...
        /*###*/
         ...
         $(".sales_order").select2({
            ...
            dropdownParent: $('#DeliveryNoteReport'),
            ajax: {
                url: "<?= base_url(); ?>Crm/DeliveryNoteReport/FetchSalesOrder",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
