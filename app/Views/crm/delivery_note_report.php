                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="DeliveryNoteReport" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <form  class="Dashboard-form class" id="delivery_note_report_form">
                                                                    ...
                                                                    <table class="table table-bordered table-striped delTable">
                                                                        ...
                                                                        <tbody  class="travelerinfo">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><select class="form-select sales_order_ref sales_order" name="" required><option>Select Order Ref</option></select></td>
                                                                                <td></td>
                                                                                <td></td>
                                                                                <td></td>
                                                                            </tr>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">View Delivery Note Reports</h4>
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#DeliveryNoteReport" class="btn btn-primary py-1">Search</button>
                                    </div><!-- end card header -->
                                    <div class="card-body">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) { 
        ...
        $(function() {
            var form = $('#delivery_note_report_form');
            ...
            form.validate({
                ...
                submitHandler: function(currentForm) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>Crm/DeliveryNoteReport/GetData",
                        method: "POST",
                        ...
                        success: function(data) {
                            ...
                            $('#delivery_note_report_form')[0].reset();
