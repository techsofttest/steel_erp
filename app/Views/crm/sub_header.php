...
<ul class="nav nav-pills nav-custom-outline nav-primary mb-3" role="tablist">
    ...
    <li class="nav-item waves-effect waves-light">
        <a class="crm_report_per nav-link <?php if($uri->getSegment(2)=="SalesQuotReports" || $uri->getSegment(2)=="SalesQuotReport" || $uri->getSegment(2)=="SalesQuotAnalysisReport" || $uri->getSegment(2)=="SalesOrderReport" || $uri->getSegment(2)=="SalesOrderToDn" || $uri->getSegment(2)=="DeliveryNoteReport" ||  $uri->getSegment(2)=="DnToCreditInvoice" || $uri->getSegment(2)=="InvoiceReport" || $uri->getSegment(2)=="SalesReturnReport" || $uri->getSegment(2)=="SalesSummery" || $uri->getSegment(2)=="BackLog" || $uri->getSegment(2)=="JobProfitability" || $uri->getSegment(2)=="JobSummery") {echo "active" ;} ?>" data-bs-toggle="" href="<?= base_url(); ?>Crm/SalesQuotReports" role="tab">Reports</a>
    </li>
</ul>
