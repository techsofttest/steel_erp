...
<h4 class="card-title mb-0 flex-grow-1" style="text-align: center;font-weight: 600;color: black;">View Receivables Payables Summarry <?php if(!empty($from_dates) && !empty($to_dates)){?>(<?php echo $from_dates;?> To <?php echo $to_dates;?>)<?php } ?></h4>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) { 
        ...
        $(".excel_button").click(
                    function () {
                        tableToExcel('DataTable','Recievables Payables Summary','Recievables Payables Summary');
                    }            
        );
        })
...
function fnExcelReport(table, fileName) {
    ...
    var pdfWindow = window.open('<?= base_url()."Accounts/Reports/RPSummery?".$_SERVER['QUERY_STRING']?>&action=Print', '_blank');
