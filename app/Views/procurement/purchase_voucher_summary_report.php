            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content text-muted">
                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="PurchaseVoucherSummaryReport" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <!--<form  class="Dashboard-form class" id="sales_quot_report_form">-->
                                <form method="GET" action="<?php echo base_url(); ?>Procurement/PurchaseVoucherSummaryReport/GetData" target="_blank" class="Dashboard-form class" id="add_form">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Purchase Voucher summary report</h5>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        <?php if (empty($_GET)): ?>
            ...
            $(window).on('load', function() {
                ...
                $('#PurchaseVoucherSummaryReport').modal('show');
            });
        ...
        $(".droup_sales").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
        ...
        $(document).ready(function() {
            $(".excel_button").click(
                function() {
                    tableToExcel('DataTable', ' Purchase Voucher summary report', 'Purchase Voucher summary report');
                }
            );
        })
        ...
        $(".vendor_dropdown").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseVoucherSummaryReport/FetchVendors",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".lpo_ref").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseVoucherSummaryReport/FetchLpoRef",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".sales_order").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseVoucherSummaryReport/FetchSalesOrder",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".product_clz").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseVoucherSummaryReport/FetchProducts",
        ...
        $(".gl_acc_clz").select2({
            ...
            dropdownParent: $('#PurchaseVoucherSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseVoucherSummaryReport/FetchGLAccounts",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
...
<script>
    ...
    document.getElementById('add_form').addEventListener('submit', function(e) {
        ...
        $('#PurchaseVoucherSummaryReport').modal('hide');
    });
</script>
    ...
    document.getElementById("email_button").addEventListener("click", function() {
        ...
        try {
            ...
            if (successful) {
                ...
                var subject = encodeURIComponent("Purchase Voucher summary report");
