    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs nav-border-top nav-border-top-primary mb-3" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link <?php if($uri->getSegment(3)=="SalesQuotAnalysisReport") {echo "active" ;} ?>"  href="<?= base_url(); ?>Procurement/SalesQuotAnalysisReport" role="tab" aria-selected="false">Purchase Order Report</a> </li>
