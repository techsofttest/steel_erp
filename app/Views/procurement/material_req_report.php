                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="MaterialRequesitionReport" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <form method="GET"
                                    action="<?php echo base_url(); ?>Procurement/MaterialReqReport/GetData"
                                    target="_blank" class="Dashboard-form class" id="add_form">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Material Requesition Report
                                            </h5>
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1"
                                            ...
                                            Material Requesition Report</h4>
                                        ...
                                        <table style="table-layout:fixed;" id="DataTable"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="white-space: nowrap;width:100px">MR
                                                        Ref</th>
                                                    ...
                                                    foreach ($material_requesition as $material_req) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center" style="white-space: nowrap;width:70px">
                                                                <?php echo date('d-M-Y', strtotime($material_req->mr_date)); ?>
                                                            </td>
                                                            <td class="text-center" style="white-space: nowrap;width:100px"><a
                                                                    href="<?php echo base_url() . 'Procurement/MaterialRequisition?view_so=' . $material_req->mr_id; ?>"
                                                                    target="_blank"><?php echo $material_req->mr_reffer_no; ?></a>
                                                            </td>


                                                            <td class="" style="white-space: nowrap;width:300px">
                                                                ...
                                                                <table class="nested-table">
                                                                    <?php foreach ($material_req->product_orders as $orders) { ?>
                                                                        <tr
                                                                            ...
                                                                            <td style=" white-space: wrap;min-width:500px">
                                                                                <?php echo $orders->product_details; ?></td>

                                                                            <td class="rotate text-center"
                                                                                style="white-space: nowrap;width:80px">
                                                                                <?php echo format_currency($orders->mrp_qty); ?>
                                                                            </td>
...
<script>
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        $(document).ready(function () {
            $(".excel_button").click(
                function () {
                    tableToExcel('DataTable', 'Material Requesition Report', 'Material Requesition Report');
                }
            );
        })
