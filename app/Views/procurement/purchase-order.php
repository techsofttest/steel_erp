                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_reffer_no" id="uid" class="form-control input_length" value="" required readonly>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_date" class="form-control mr_date datepicker_ap input_length" required readonly>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-3 col-lg-3">
                                                                        ...
                                                                        <label for="basicInput" class="form-label">Contact Person <span class="add_more_icon add_new contact_new_modal ri-add-line"></span></label>
                                                                    
                                                                    </div>

                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        
                                                                        <select class="form-select add_contact_person input_length" name="po_contact_person" id="" required></select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-3 col-lg-3">
                                                                        ...
                                                                        <label for="basicInput" class="form-label">MRN Ref<span class="add_more_icon cust_more_modal ri-add-line" id="blink"></span></label>
                                                                    </div>

                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        
                                                                        <select class="form-select input_length" name="po_mrn_reff" id="po_mrn_reff_id" required>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text " name="po_payment_term" class="form-control add_payment_term input_length " value="" required>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_delivery_date" class="form-control time_frame_date datepicker input_length " value="" required>
                                                                    </div>
                                                ...
                                                <div class="mt-4 content_table">
                                                    <table class="table table-bordered table-striped delTable selected_table add_table" style="display:none;">
                                                        <thead class="travelerinfo">
                                                            <tr>
                                                                <td style="width: 45px;">SI</td>
                                                                <td style="width: 110px;">Sales Order</td>
                                                    ...
                                                    <table class="total_table" style="display:none;">
                                                        <tbody>
                                                            <tr>
		                                                        ...
		                                                        <td><input type="text" name="po_amount" class="amount_total form-control text-end" readonly=""></td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        ...
                                                                        <input type="text" name="" class="form-control view_mrn_ref input_length" readonly>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="" class="form-control view_delivery_date input_length" readonly>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name=""  class="form-control view_vendor_ref input_length" readonly>
                                                                    </div>
			                        ...
			                        <div class="modal-content">
				                        ...
				                        <div class="modal-body">
                                            ...
                                            <div class="live-preview">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_reffer_no"  class="form-control edit_reff input_length"  required readonly>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_date" class="form-control edit_date datepicker input_length" required readonly>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <select class="form-select edit_vendor input_length" name="po_vendor_name" required="" aria-required="true"></select>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <select class="form-select edit_contact input_length" name="po_contact_person" required="" aria-required="true"></select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        ...
                                                                        <input type="text" name="" class="form-control  edit_mrn_ref input_length" value="" readonly>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_payment_term" class="form-control  edit_payment_term input_length" value="" required>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_delivery_date" class="form-control  datepicker edit_delivery_date input_length" required>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row align-items-center mb-2 margin_zero">
                                                                    ...
                                                                    <div class="col-col-md-9 col-lg-9">
                                                                        <input type="text" name="po_vendor_ref" class="form-control edit_vendor_ref input_length" value="" required>
                                                                    </div>
                                                ...
                                                <!--table section start-->
                                                <div class="mt-4 content_table">
                                                    <table class="table table-bordered table-striped add_table">
                                                        <thead class="travelerinfo">
                                                    ...
                                                    <table class="total_table" style="width: 255px !important;">
                                                        <tbody>

                                                            <tr>
                                                                
                                                                <td align="right" class="total_label" style="width: 170px;">Total</td>
       ...
       function InitSelect2(){
        ...
        function initializeDataTable() {
            ...
            'columns': [
               ...
               columnDefs: [
                 { targets: [0,1,2,5], className: "dt-body-center" },
