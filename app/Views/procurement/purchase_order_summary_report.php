            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content text-muted">
                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="PurchaseOrderSummaryReport" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <!--<form  class="Dashboard-form class" id="sales_quot_report_form">-->
                                <form method="GET"
                                    action="<?php echo base_url(); ?>Procurement/PurchaseOrderSummaryReport/GetData"
                                    target="_blank" class="Dashboard-form class" id="add_form">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Purchase Order Summary Report</h5>
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1"
                                            ...
                                            Purchase Order Summary Reports</h4>
                                    ...
                                    <div class="card-body table-responsive divcontainer" style=" overflow-x:scroll;">
                                        ...
                                        <table style="table-layout:;" id="DataTable"
                                            ...
                                            <tbody class="tbody_data">
                                                <?php if (!empty($purchase_order)):
                                                    ...
                                                    <!-- TOTAL ROW -->
                                                    <tr class="fw-bold">
                                                        <th colspan="4" class="text-start" style="white-space: nowrap;">
                                                            Total</th>
...
<script>
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        <?php if (empty($_GET)): ?>
            ...
            $(window).on('load', function () {
                ...
                $('#PurchaseOrderSummaryReport').modal('show');
            });
        ...
        $(".droup_sales").select2({
            ...
            dropdownParent: $('#PurchaseOrderSummaryReport'),
        ...
        $(document).ready(function () {
            $(".excel_button").click(
                function () {
                    tableToExcel('DataTable', 'Purchase Order Summary Report', 'Purchase Order Summary Report');
                }
            );
        })
    ...
    /*Vendor dropdown search*/
        $(".vendor_dropdown").select2({
            ...
            dropdownParent: $('#PurchaseOrderSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseOrderSummaryReport/FetchVendors",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".sales_order").select2({
            ...
            dropdownParent: $('#PurchaseOrderSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseOrderSummaryReport/FetchSalesOrder",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".product_clz").select2({
            ...
            dropdownParent: $('#PurchaseOrderSummaryReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PurchaseOrderSummaryReport/FetchProducts",
...
<script>
    ...
    document.getElementById('add_form').addEventListener('submit', function (e) {
        ...
        $('#PurchaseOrderSummaryReport').modal('hide');
    });
</script>
    ...
    document.getElementById("email_button").addEventListener("click", function () {
        ...
        try {
            ...
            if (successful) {
                ...
                var subject = encodeURIComponent("Purchase Order Summary Report");
