            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content text-muted">
                    ...
                    <div class="tab-pane active" id="arrow-1" role="tabpanel">
                        ...
                        <div class="modal fade" id="PendingPurchaseVoucherReport" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form method="GET" action="<?php echo base_url(); ?>Procurement/PendingPurchaseVoucherReport/GetData" target="_blank" class="Dashboard-form class" id="add_form">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Pending Purchase Voucher Report</h5>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        <?php if (empty($_GET)): ?>
            ...
            $(window).on('load', function() {
                ...
                $('#PendingPurchaseVoucherReport').modal('show');
            });
        ...
        $(".vendor_dropdown").select2({
            ...
            dropdownParent: $('#PendingPurchaseVoucherReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PendingPurchaseVoucherReport/FetchVendors",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
        ...
        $(".product_clz").select2({
            ...
            dropdownParent: $('#PendingPurchaseVoucherReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PendingPurchaseVoucherReport/FetchProducts",
        ...
        $(".gl_acc_clz").select2({
            ...
            dropdownParent: $('#PendingPurchaseVoucherReport'),
            ajax: {
                url: "<?= base_url(); ?>Procurement/PendingPurchaseVoucherReport/FetchGLAccounts",
                dataType: 'json',
                delay: 250,
                cache: false,
                minimumInputLength: 1,
...
<script>
    ...
    document.getElementById('add_form').addEventListener('submit', function(e) {
        ...
        $('#PendingPurchaseVoucherReport').modal('hide');
    });
</script>
