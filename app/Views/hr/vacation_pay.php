            ...
            <div class="live-preview">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <th class="text-center">Vacation Due From</th>
                            ...
                            <th class="text-end" colspan="7"></td>

                            <th class="text-center"><b>Total</b></th>

                            <th class="text-end" style="padding:.55rem 6px !important" id="total_vp_view"></th>
...
<input id="current_balance" type="text" class="form-control" readonly>
