    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs nav-border-top nav-border-top-primary mb-3" role="tablist">
          <li class="nav-item"><a class="nav-link <?php if($uri->getSegment(3)=="ProductHead") {echo "active" ;} ?>"  href="<?= base_url(); ?>Crm/ProductHead" role="tab" aria-selected="true">Product Details </a></li>
          <li class="nav-item"><a class="nav-link <?php if($uri->getSegment(3)=="Products") {echo "active" ;} ?>"  href="<?= base_url(); ?>Crm/Products" role="tab" aria-selected="true">Products </a></li>
          ...
          <li class="nav-item"><a class="nav-link <?php if($uri->getSegment(3)=="DeliverNote"){echo "active";}?>"  href="<?= base_url();?>Crm/DeliverNote" role="tab" aria-selected="false">Delivery Note</a> </li>
          <li class="nav-item"><a class="nav-link <?php if($uri->getSegment(3)=="CashInvoice"){echo "active";}?>"  href="<?= base_url();?>Crm/CashInvoice" role="tab" aria-selected="false">Cash Invoice</a> </li>
