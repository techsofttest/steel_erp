                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1" style="text-align: center;font-weight: 600;color: black;">View Sales Order To Dn <?php if(!empty($from_dates) && !empty($to_dates)){?>(<?php echo $from_dates;?> To <?php echo $to_dates;?>)<?php } ?></h4>
                                        ...
                                        <table style="table-layout:fixed;" id="DataTable" class="table table-bordered table-striped delTable display dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="100px" class="text-end">Quantity</th>
                                            ...
                                            <?php
                                                ...
                                                if(!empty($sales_orders))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap;width:100px"><?php echo date('d-M-Y',strtotime($sales_order->so_date));?></td>
                                                        <td style="white-space: nowrap;width:100px"><a href="<?php echo base_url();?>Crm/SalesOrder?view_so=<?php echo $sales_order->so_id;?>" target="_blank"><?php echo $sales_order->so_reffer_no;?></a></td>
                                                        <td style="white-space: nowrap;width:500px"><?php echo $sales_order->cc_customer_name;?></td>
                                                        <td style="white-space: nowrap;width:100px"><?php echo $sales_order->so_lpo;?></td>
                                                        <td style="white-space: nowrap;width:100px"><?php echo $sales_order->se_name;?></td>
                                                            ...
                                                            <table>
                                                                <?php foreach($sales_order->sales_products as $sales_prod){?>
                                                                    <tr style="background: unset;border-bottom: hidden !important;">
                                                                        ...
                                                                        <td class="rotate text-end"  width="100px"><?php echo $sales_prod->spd_quantity;?></td>
                                                                        <td class="rotate text-end" width="100px"><?php echo format_currency($sales_prod->spd_rate);?></td>
                                                                        <td class="rotate text-end" width="100px"><?php echo $sales_prod->spd_discount;?></td>
